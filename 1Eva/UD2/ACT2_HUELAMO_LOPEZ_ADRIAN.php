...
<body>
    ...
    <?php } else { ?>
        ...
        <tr>
            ...
            <td>Comentario: <?php echo $comentario[2]?></td><br><br>
        </tr>
        <?php endforeach;

    // No he consegido que vaya el segundo formulario, pero si existe comentarios ya preescritos 
    // en comentarios.txt funciona perfectamente, pero al intentar hacer el segundo formulario
    // me da error y se fastidia la página, lo he dejado comentado
