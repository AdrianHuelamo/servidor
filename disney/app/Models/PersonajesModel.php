...
class PersonajesModel extends Model
{
    ...
    {
        $builder = $this->select('personajes.id, personajes.nombre as personaje_nombre, personajes.id_pelicula, peliculas.titulo as pelicula_nombre') 
        ->join('peliculas', 'personajes.id_pelicula = peliculas.id');
