...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center" style="min-height: calc(100vh - 56px); padding: 20px;">
        <div class="login-wrap p-4 p-md-5" style="width: 100%; max-width: 420px;">
            <?php if ($mensaje_info): ?>
