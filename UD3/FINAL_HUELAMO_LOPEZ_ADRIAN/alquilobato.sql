...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2025 a las 19:11:18
...
(3, 'Adahi', 'adahi@solvam.es', 961547793, 'adahi', '$2y$10$VsoEjn/ZHEuJOO87GTP8nO5Bf0vPWXBRrgCnWKi/fQ1L6fIvoDNdK', 'editor', 'images/adahi.jpg', 'Luchador profesional de Lucha Turca, 8 veces campeón del mundo en esa disciplina'),
...
ALTER TABLE `coches`
  ...
  ADD UNIQUE KEY `idx_coche_marca_unica` (`nombre`,`id_categoria`),
  ADD UNIQUE KEY `idx_imagen_coche_unica` (`imagen`),
...
ALTER TABLE `usuarios`
  ...
  ADD UNIQUE KEY `idx_username_unico` (`username`),
...
--
ALTER TABLE `coches`
  MODIFY `id_coche` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `fk_reserva_coche` FOREIGN KEY (`id_coche`) REFERENCES `coches` (`id_coche`) ON UPDATE CASCADE,
